...
public class FBStringField extends FBField {
    ...
    public byte getByte() throws SQLException {
        ...
        try {
            ...
            throw (SQLException) createException(BYTE_CONVERSION_ERROR + " " + getString().trim()).fillInStackTrace();
        }
    }
    ...
    public short getShort() throws SQLException {
        ...
        try {
            ...
            throw (SQLException) createException(SHORT_CONVERSION_ERROR + " " + getString().trim()).fillInStackTrace();
        }
    }
    ...
    public int getInt() throws SQLException {
        ...
        try {
            ...
            throw (SQLException) createException(INT_CONVERSION_ERROR + " " + getString().trim()).fillInStackTrace();
        }
    }
    ...
    public long getLong() throws SQLException {
        ...
        try {
            ...
            throw (SQLException) createException(LONG_CONVERSION_ERROR + " " + getString().trim()).fillInStackTrace();
        }
    }
    ...
    public float getFloat() throws SQLException {
        ...
        try {
            ...
            throw (SQLException) createException(FLOAT_CONVERSION_ERROR + " " + getString().trim()).fillInStackTrace();
        }
    }
    ...
    public double getDouble() throws SQLException {
        ...
        try {
            ...
            throw (SQLException) createException(DOUBLE_CONVERSION_ERROR + " " + getString().trim()).fillInStackTrace();
        }
    }

    public boolean getBoolean() throws SQLException {
        if (getFieldData() == null) return BOOLEAN_NULL_VALUE;
        return getString().trim().equalsIgnoreCase(LONG_TRUE) || getString().trim().equalsIgnoreCase(SHORT_TRUE) || getString().trim().equalsIgnoreCase(SHORT_TRUE_2) || getString().trim().equalsIgnoreCase(SHORT_TRUE_3);
    }
    ...
    public void setBoolean(boolean value) throws SQLException {
        if (field.sqllen == 1) setString(value ? SHORT_TRUE : SHORT_FALSE); else if (field.sqllen / bytesPerCharacter > 4) setString(value ? LONG_TRUE : LONG_FALSE);
    }
    ...
    public void setBinaryStream(InputStream in, int length) throws SQLException {
        ...
        if (length > field.sqllen) throw new DataTruncation(-1, true, false, length, field.sqllen);
        try {
    ...
    public void setBytes(byte[] value) throws SQLException {
        ...
        setFieldData(value);
        if (value.length > field.sqllen) throw new DataTruncation(-1, true, false, value.length, field.sqllen);
    }
