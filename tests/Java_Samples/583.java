...
public class AlFormatterTest {
    ...
    public static final String[][] SOURCE_ARRAY = new String[][] { new String[] { "Ala ma kota kot ma\tale nie wie.\nDrugie.", "Burza mózgów zawsze dobrze robi." }, new String[] {}, new String[] {} };

    public static final String[][] TARGET_ARRAY = new String[][] { new String[] { "Wasserreservoir, Wasserreservoir..." }, new String[] {}, new String[] { "Immer nur Wasser" } };
